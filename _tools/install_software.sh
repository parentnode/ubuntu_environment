...
if test "$install_software" = "Y"; then
	...
	# INSTALL PHP5.5
	sudo apt install -y libapache2-mod-php php5 php5-cli php5-common php5-curl php5-dev php-imagick php5-mcrypt php5-mbstring php5-zip php-memcached php5-mysql php5-xmlrpc memcached
