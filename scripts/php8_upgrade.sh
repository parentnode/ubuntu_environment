...
command "sudo mv /srv/tools/conf-server/php-8.2-apache2.ini /etc/php/8.2/apache2/php.ini"
command "sudo mv /srv/tools/conf-server/php-8.2-cli.ini /etc/php/8.2/cli/php.ini"
